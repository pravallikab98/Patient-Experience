...
@Component({
  selector: 'app-cylinderCharts',
  templateUrl: './cylindercharts.component.html',
  styleUrls: ['./cylindercharts.component.css']
})
export class CylinderchartsComponent implements OnInit {
  @Input()
  data:Data[];
  ...
  ngOnInit() {
    this.zone.runOutsideAngular(() => {
      var chart = am4core.create("cylindercharts", am4charts.XYChart3D);
