...
@Component({
  selector: 'app-barcharttriangle',
  templateUrl: './barchart-triangle.component.html',
  styleUrls: ['./barchart-triangle.component.css']
})
export class BarchartTriangleComponent implements OnInit {
  ...
  ngOnInit() {
    this.zone.runOutsideAngular(() => {
      var chart = am4core.create('barChart-triangle', am4charts.XYChart);
